  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-16 mb-16 px-6 max-w-[30rem] lg:max-w-[90rem] mx-auto">
      ...
      <div className="flex flex-col gap-3 lg:justify-between items-center">
        ...
        <p className="text-center">Notre service de diagnostic complet couvre plus de 140 marques de voitures, vous garantissant une analyse précise et fiable de votre véhicule. Faites confiance à notre expertise pour identifier et résoudre rapidement tous vos problèmes automobile.</p>
